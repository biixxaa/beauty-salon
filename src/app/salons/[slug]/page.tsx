...
import { Star, ShieldCheck, MapPin, Phone, Mail, Clock, Calendar, Sparkles, Check, ChevronRight, X, User, ShoppingBag, Percent, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col pb-20">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-6 lg:px-8 pb-8 text-white flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="flex flex-col items-end">
              ...
              <span className="text-xs text-zinc-300 mt-1 font-semibold">{salon.reviewCount} reviews</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl w-full px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
        ...
        {/* Left 2 Columns: Services & Reviews */}
        <div className="lg:col-span-2 flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-2 bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/65 p-6 rounded-2xl">
            ...
            <p className="text-sm text-zinc-550 dark:text-zinc-400 leading-relaxed mt-1">
              ...
              {salon.services.map((service: any) => (
                ...
                >
                  <div className="flex flex-col gap-1 pr-4">
                    <h4 className="font-bold text-sm text-zinc-900 dark:text-zinc-150">{service.name}</h4>
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    ...
                    <button
                      onClick={() => {
                        ...
                        // Default to the first employee offering the service
                        if (service.employees?.length > 0) {
                          setSelectedEmployee(service.employees[0].employee);
                  ...
                  <div key={rev.id} className="p-5 bg-white dark:bg-zinc-900 border border-zinc-200/50 dark:border-zinc-800/50 rounded-2xl flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        <div className="flex h-9 w-9 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-650 shrink-0">
                    ...
                    {rev.reply && (
                      <div className="bg-amber-500/5 border-l-2 border-amber-500 p-3 rounded-r-xl text-[11px] leading-relaxed text-zinc-650 dark:text-zinc-400">
                        <strong className="text-zinc-850 dark:text-zinc-250 block mb-0.5">Owner Response:</strong>
                        {rev.reply}
                      </div>
                    )}
                  </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-zinc-800/60 p-6 rounded-2xl flex flex-col gap-4.5">
            <h4 className="font-extrabold text-sm text-zinc-900 dark:text-zinc-100 uppercase tracking-wide">Contacts & Location</h4>
            
            <div className="flex flex-col gap-3 text-xs text-zinc-550 dark:text-zinc-400">
              <div className="flex items-center gap-2">
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleBookingSubmit} className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
                        ...
                        <button
                          ...
                          className={`py-2 rounded-xl border text-xs font-bold text-center transition-all ${
                            selectedSlot === slot
                              ...
                              : 'border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-55'
                          }`}
                        >
                          {slot}
                        </button>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 bg-zinc-900 dark:bg-zinc-100 hover:bg-black text-white dark:text-zinc-900 text-xs font-bold rounded-xl transition-colors shrink-0"
                  >
                    Apply
                  </button>
                </div>
              ...
              <button
                ...
                className="w-full mt-4 py-4 bg-amber-500 hover:bg-amber-600 disabled:bg-zinc-300 disabled:dark:bg-zinc-800 text-white font-bold rounded-2xl text-center shadow-lg transition-all"
              >
